...
class CosmicMessage(Base):
    ...
    title = Column(String(256), index=True, server_default=None)
    author = Column(String(256), server_default=None)
    tags = Column(JSON, server_default=None)
    description = Column(String(521), server_default=None)
    abstract = Column(String(521), server_default=None)
